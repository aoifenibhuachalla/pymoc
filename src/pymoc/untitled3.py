...
class Column(object):
  ...
  def __init__(self,
      ...
      qs=None,      # surface tracer boundary condition (optional)
      qbot=None,    # bottom tracer boundary condition (optional)
      qzbot=None    # bottom tracer gradient boundary condition (optional)
  ):
    r"""
    Parameters
    ----------
